<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master.Master" AutoEventWireup="true" CodeBehind="InsertProduct.aspx.cs" Inherits="TokoBeDia.View.InsertProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="form-group">
            <asp:label for="inputTypeID" runat="server">Type[ID]</asp:label>
            <input runat="server" type="text" class="form-control" id="inputTypeID" placeholder="Type[ID]" required>
        </div>
        <div class="form-group">
